...
public class SwaggerConfig {
	...
	private final ResponseMessage m201 = customMessage1(); //mensagem personalizada 
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.useDefaultResponseMessages(false)  //desabilito as resposta padrões e coloca as customizadas 
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.natanlf.cursomc.resources")).paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}
