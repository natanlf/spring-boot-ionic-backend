...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7)); //coloca meus objetos em lista para salvar
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "natan.developer@gmail.com", "23545885254", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("25789812","37146785"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "natanlaraferreira@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
